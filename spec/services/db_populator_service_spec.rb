...
describe DbPopulatorService do
  ...
  it 'should successfully populate with given csv file' do
    ...
    DbPopulatorService.populate_from_file('./fixtures/test_file.csv', db: @db, file_type: 'csv', table_name: 'tests')
  ...
  it 'should fail with a file type different from csv' do
    @db.reset_table(table_name: 'tests')
    result = DbPopulatorService.populate_from_file('./fixtures/test_file.csv', db: @db, file_type: 'json', table_name: 'tests')
